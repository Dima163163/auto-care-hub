...
test('legacy payment scan ignores all generated Next output variants', () => {
    ...
    assert.equal(isIgnoredDirectory('.next-final-rehearsal'), true)
    assert.equal(isIgnoredDirectory('output'), true)
