...
const featuredProviderPreviews: readonly ProviderPreview[] = [
    {
        id: 'proservice-moscow', name: 'ProService', rating: 3.6, reviewCount: 12,
    ...
    {
        id: 'autolux-moscow', name: 'AutoLux', rating: 3.6, reviewCount: 12,
    ...
    {
        id: 'formula-moscow', name: 'Formula Motion', rating: 3.6, reviewCount: 12,
