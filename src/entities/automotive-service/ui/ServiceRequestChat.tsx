...
export function ServiceRequestChat({ requestId, ownerMode = false }: ServiceRequestChatProps) {
    ...
    const conversation = useGetAutoCareServiceConversationQuery(requestId, { pollingInterval: 15_000 })
