...
export function BrandLogo({ size = 'md' }: BrandLogoProps) {
    return (
        ...
        >
            ...
            <text x="73" y="33" fill="currentColor" fontFamily="Russo One, Onest Variable, Onest, Arial, sans-serif" fontSize="24" fontWeight="400" letterSpacing="-.6">
                AutoCare <tspan fill="var(--primary)">Hub</tspan>
            </text>
            <text x="74" y="50" fill="var(--map-pin)" opacity=".75" fontFamily="Onest Variable, Onest, Arial, sans-serif" fontSize="9.2" fontWeight="500">
