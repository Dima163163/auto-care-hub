...
export const itTranslations = createEuropeanLocale({
    ...
    navigation: { home: 'Home', services: 'Servizi auto', myBookings: 'Le mie richieste', favorites: 'Preferiti', owners: 'Per le officine', about: 'Chi siamo' },
...
export const plTranslations = createEuropeanLocale({
    ...
    navigation: { home: 'Strona główna', services: 'Usługi auto', myBookings: 'Moje zgłoszenia', favorites: 'Ulubione', owners: 'Dla serwisów', about: 'O nas' },
...
export const nlTranslations = createEuropeanLocale({
    ...
    navigation: { home: 'Home', services: 'Autoservices', myBookings: 'Mijn aanvragen', favorites: 'Favorieten', owners: 'Voor garages', about: 'Over ons' },
...
export const ukTranslations = createEuropeanLocale({
    ...
    navigation: { home: 'Головна', services: 'Автопослуги', myBookings: 'Мої заявки', favorites: 'Обране', owners: 'Для сервісів', about: 'Про нас' },
...
export const csTranslations = createEuropeanLocale({
    ...
    navigation: { home: 'Domů', services: 'Autoslužby', myBookings: 'Moje žádosti', favorites: 'Oblíbené', owners: 'Pro servisy', about: 'O nás' },
...
export const elTranslations = createEuropeanLocale({
    ...
    navigation: { home: 'Αρχική', services: 'Υπηρεσίες αυτοκινήτου', myBookings: 'Τα αιτήματά μου', favorites: 'Αγαπημένα', owners: 'Για συνεργεία', about: 'Σχετικά με εμάς' },
...
export const svTranslations = createEuropeanLocale({
    ...
    navigation: { home: 'Hem', services: 'Bilservice', myBookings: 'Mina förfrågningar', favorites: 'Favoriter', owners: 'För verkstäder', about: 'Om oss' },
