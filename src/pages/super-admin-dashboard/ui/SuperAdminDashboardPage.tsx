        ...
        <section className="mx-auto max-w-6xl space-y-5">
            ...
            {query.data && <>
                <section className="grid gap-3 sm:grid-cols-2 xl:grid-cols-3">
                    <Metric icon={Globe2} label={text.markets} value={formatInteger(query.data.markets.length)} note={query.data.markets.map((market) => market.cityName).join(' · ') || text.notProvided} />
