...
import { confirmMarketDeletion, parseNames, parseOptionalFiniteNumber } from './market-hierarchy-form-utils'
...
type Props = { city: AutoCareApiMarket; zones: AutoCareApiLocationZone[]; onSubmit: (input: ZoneInput) => Promise<unknown>; onDelete?: (zoneId: string) => Promise<unknown>; state: SubmitState }
