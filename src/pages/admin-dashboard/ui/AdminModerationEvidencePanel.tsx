import { CheckCircle2, FileImage, MessageSquareText, Star, XCircle } from 'lucide-react'
...
function evidenceKindIcon(kind: AdminAutoCareModerationEvidence['kind']) {
    return kind === 'review' ? <MessageSquareText className="size-5" /> : <FileImage className="size-5" />
}
