...
const copy = {
    ...
    en: {
        ...
        failedDecision: 'Could not save the decision. Check the appeal and try again.',
        status: 'Status',
        subject: 'Subject',
        all: 'All',
...
export function AdminAutoCareAppealsPanel() {
    ...
    return <section id="admin-appeals" className="scroll-mt-24 rounded-[var(--radius-panel)] border border-border bg-card p-5 shadow-sm">
        ...
        {decisionState.error && <div role="alert" className="mt-5 rounded-[var(--radius-card)] border border-destructive/30 bg-destructive/5 p-4 text-sm font-semibold text-destructive">{getApiErrorMessage(decisionState.error, text.failedDecision)}</div>}
