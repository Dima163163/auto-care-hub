...
export function AutoCareReviewResolutionPanel() {
    ...
    const saveReview = async () => {
        ...
        setEditError(null)
        try {
            await updateReview({ reviewId: selectedReview.id, rating: Number(rating), text: text.trim() }).unwrap()
