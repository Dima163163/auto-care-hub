...
describe('AutoCare result filters', () => {
    it('restores all supported filters from a shareable URL', () => {
        ...
        expect(filters).toEqual({ serviceId: 'body-paint', providerName: '', marketId: 'moscow', zoneId: '', radiusKm: 50, sort: 'rating_desc', minPrice: '2000', maxPrice: '15000', minRating: '4.7', priceType: 'quote_required', availableToday: true, verifiedOnly: true, warrantyOnly: true, hasBonus: true, inclusion: 'photo', brandId: 'bmw', vehicleModel: '', vehicleYear: '' })
    })
