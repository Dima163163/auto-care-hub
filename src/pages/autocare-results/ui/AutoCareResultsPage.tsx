...
export function AutoCareResultsPage() {
    ...
    const activeFilters = useMemo<readonly ActiveFilter[]>(() => [
        ...
        draftFilters.minPrice ? { key: 'minPrice', label: t('autocare.fromPrice', { price: draftFilters.minPrice }) } : null,
        draftFilters.maxPrice ? { key: 'maxPrice', label: t('autocare.toPrice', { price: draftFilters.maxPrice }) } : null,
