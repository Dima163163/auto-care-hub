...
export function FairPriceBenchmarkCard({ serviceId, marketId }: FairPriceBenchmarkCardProps) {
    ...
    const copy = {
        title: t('autocare.fairPriceTitle'),
        min: t('autocare.fairPriceFrom'),
        median: t('autocare.fairPriceTypical'),
        max: t('autocare.fairPriceTo'),
        note: t('autocare.fairPriceNote'),
        sample: t('autocare.fairPriceVerifiedOffers'),
        source: t('autocare.fairPriceSource'),
    }
