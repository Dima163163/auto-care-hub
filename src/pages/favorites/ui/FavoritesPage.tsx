...
export function FavoritesPage() {
    ...
    const { favoriteIds, toggle } = useAutoCareFavorites()
    const providers = providerPreviews.filter((provider) => favoriteIds.has(provider.id))
