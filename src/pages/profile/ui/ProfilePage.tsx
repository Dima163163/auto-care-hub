    ...
    return (
        <main className="mx-auto max-w-[var(--layout-operational-max)] space-y-6 px-[var(--layout-gutter)] py-7 lg:py-10">
            ...
            <div className="min-w-0 space-y-6">
                    ...
                    <div role="tablist" aria-label={t('profile.title')} className="flex overflow-x-auto border-b border-border bg-card px-2">
                        {tabs.map((tab) => {
                    ...
                    >
                        {activeTab === 'general' && (
                            <div className="grid gap-6">
                                ...
                                {user.role === 'client' && <CommunityProfileSettings />}
