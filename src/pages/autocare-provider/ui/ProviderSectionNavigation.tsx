...
export function ProviderSectionNavigation() {
    ...
    return (
        <nav aria-label={t('autocare.providerProfile')} className="border-b border-border bg-card shadow-sm">
            <div data-testid="provider-section-navigation-container" className="mx-auto flex max-w-[var(--layout-public-wide-max)] gap-1 overflow-x-auto px-[var(--layout-public-gutter)] py-2">
