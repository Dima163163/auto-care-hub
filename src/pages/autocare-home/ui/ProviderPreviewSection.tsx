            ...
            <div className="relative mx-auto max-w-[var(--layout-public-max)] px-[var(--layout-gutter)]">
                ...
                <div className="mt-5 grid gap-4 lg:grid-cols-4" aria-busy={isInitialLoading}>
                    {isInitialLoading
                        ...
                        : visibleProviders.map((provider) => <ProviderCard key={provider.id} provider={provider} locale={locale} />)}
                </div>
...
function ProviderCard({ provider, locale }: { provider: HomeProvider; locale: string }) {
