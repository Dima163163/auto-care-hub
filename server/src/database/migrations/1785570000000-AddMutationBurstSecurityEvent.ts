...
export class AddMutationBurstSecurityEvent1785570000000 implements MigrationInterface {
    name = 'AddMutationBurstSecurityEvent1785570000000'
    ...
    async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`
            ...
            CHECK ("type" IN (
                ...
                'privilege_denied', 'webhook_abuse', 'mutation_burst'
            ))
        `)
    }
