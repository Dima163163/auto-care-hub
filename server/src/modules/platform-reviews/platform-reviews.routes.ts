...
export async function platformReviewsRoutes(app: FastifyInstance) {
    ...
    app.post('/v1/platform-reviews', async (request) => createPlatformReview(await requireVerifiedEmail(request), validateBody(createPlatformReviewSchema, request.body)))
