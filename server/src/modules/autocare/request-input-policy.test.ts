...
describe('AutoCare service request input policy', () => {
    ...
    it('keeps partial contact snapshots for internal fixtures while validating present fields', () => {
        expect(normalizeAutoCareServiceRequestInput({ providerId: '11111111-1111-4111-8111-111111111111', locationId: '22222222-2222-4222-8222-222222222222', offeringId: '33333333-3333-4333-8333-333333333333', preferredAt: '2036-09-04T10:30:00.000Z', contactSnapshot: { name: 'Client', phone: '+10000000000' } })?.contactSnapshot).toEqual({ name: 'Client', phone: '+10000000000' })
    })

    it('rejects malformed identifiers, dates and contact values', () => {
        const base = { providerId: '11111111-1111-4111-8111-111111111111', locationId: '22222222-2222-4222-8222-222222222222', offeringId: '33333333-3333-4333-8333-333333333333', preferredAt: '2036-09-04T10:30:00.000Z', contactSnapshot: { name: 'Client', phone: '+10000000000' } }
